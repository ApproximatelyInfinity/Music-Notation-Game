...
document.querySelector('#settings').addEventListener('click', function() {
	if(flag_settings == true) {
		flag_settings = false;
		document.getElementById("settings").src="assets/images/icons/close.png";
		document.getElementById("settings-menu").style.display = "block";
	}else if(flag_settings == false){
		flag_settings = true;
		document.getElementById("settings").src="assets/images/icons/settings.png";
...
function audioChange() {
	switch(ans) {
		case "A":
			if(img == "a2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/a2.ogg";
			}else if(img == "a3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/a3.ogg";
			}else if(img == "a4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/a4.ogg";
			}else if(img == "a5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/a5.ogg";
			}
			break;
		case "B":
			if(img == "b2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b2.ogg";
			}else if(img == "b3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b3.ogg";
			}else if(img == "b4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b4.ogg";
			}else if(img == "b5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b5.ogg";
			}
			break;
		case "C":
			if(img == "c2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/c2.ogg";
			}else if(img == "c3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/c3.ogg";
			}else if(img == "c4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/c4.ogg";
			}else if(img == "c5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/c5.ogg";
			}else if(img == "c6.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/c6.ogg";
			}
			break;
		case "D":
			if(img == "d2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/d2.ogg";
			}else if(img == "d3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/d3.ogg";
			}else if(img == "d4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/d4.ogg";
			}else if(img == "d5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/d5.ogg";
			}
			break;
		case "E":
			if(img == "e2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/e2.ogg";
			}else if(img == "e3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/e3.ogg";
			}else if(img == "e4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/e4.ogg";
			}else if(img == "e5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/e5.ogg";
			}
			break;
		case "F":
			if(img == "f2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/f2.ogg";
			}else if(img == "f3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/f3.ogg";
			}else if(img == "f4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/f4.ogg";
			}else if(img == "f5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/f5.ogg";
			}
			break;
		case "G":
			if(img == "g2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/g2.ogg";
			}else if(img == "g3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/g3.ogg";
			}else if(img == "g4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/g4.ogg";
			}else if(img == "g5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/g5.ogg";
			}
			break;
		case "Ab":
			if(img == "af2.png") {
				document.getElementById("myAudio").src = "assets/audio/notes/single/gs2.ogg";
			}else if(img == "af3.png") {
				document.getElementById("myAudio").src = "assets/audio/notes/single/gs3.ogg";
			}else if(img == "af4.png") {
				document.getElementById("myAudio").src = "assets/audio/notes/single/gs4.ogg";
			}else if(img == "af5.png") {
				document.getElementById("myAudio").src = "assets/audio/notes/single/gs5.ogg";
			}
			break;
		case "Bb":
			if(img == "bf2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/as2.ogg";
			}else if(img == "bf3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/as3.ogg";
			}else if(img == "bf4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/as4.ogg";
			}else if(img == "bf5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/as5.ogg";
			}
			break;
		case "Cb":
			if(img == "cf2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b1.ogg";
			}else if(img == "cf3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b2.ogg";
			}else if(img == "cf4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/b3.ogg";
		...
		case "Db":
			if(img == "df2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/cs2.ogg";
			}else if(img == "df3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/cs3.ogg";
			}else if(img == "df4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/cs4.ogg";
			}else if(img == "df5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/cs5.ogg";
			}
			break;
		case "Eb":
			if(img == "ef2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/ds2.ogg";
			}else if(img == "ef3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/ds3.ogg";
			}else if(img == "ef4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/ds4.ogg";
			}else if(img == "ef5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/ds5.ogg";
			}
			break;
		case "Fb":
			if(img == "ff2.png") {
		...
		case "Gb":
			if(img == "gf2.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/fs2.ogg";
			}else if(img == "gf3.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/fs3.ogg";
			}else if(img == "gf4.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/fs4.ogg";
			}else if(img == "gf5.png") {
				document.getElementById('myAudio').src = "assets/audio/notes/single/fs5.ogg";
			}
			break;
		case "A#":
			if(img == "as2.png") {
		...
		case "C#":
			if(img == "cs2.png") {
				...
				document.getElementById('myAudio').src = "assets/audio/notes/single/cs6.ogg";
			}
			break;
		case "D#":
			if(img == "ds2.png") {
	...
	if(flag_grand == true) {
		switch(ans) {
			case "A":
				...
				document.getElementById('myImage').src = "assets/images/resources/notationtrainer/grand/"+img;
				break;
			case "B":
		...
		switch(ans) {
			case "A":
				...
				document.getElementById('myImage').src = "assets/images/resources/notationtrainer/treble/"+img;
				break;
			case "B":
		...
		switch(ans) {
			case "A":
				...
				document.getElementById('myImage').src = "assets/images/resources/notationtrainer/bass/"+img;
				break;
			case "B":
